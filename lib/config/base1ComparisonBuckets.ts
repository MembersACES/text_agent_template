...
- Gas: min annual ${buckets.gas.minAnnualUsageGj} GJ; near-C&I [${buckets.gas.nearCi.minGj}, ${buckets.gas.nearCi.maxGj}) uses first-tier $/GJ labelled Potential (C&I 70%); tiers ${gasTiers}; resolve gas_rate_per_gj / usage charges / ex-supply / all-in; bundled bills multiply that rate ×${buckets.gas.bundledEnergyMultiplier} before comparing.
